...
public class MovieContract {
    ...
    public static final class MovieEntry implements BaseColumns {
        ...
        // Columns
        public static final String CONLUMN_ORIGINAL_TITLE = "original_title";
        public static final String CONLUMN_VOTE_AVERAGE = "vote_average";
        public static final String CONLUMN_OVERVIEW = "overview";
        public static final String CONLUMN_RELEASE_DATE = "release_date";
        public static final String CONLUMN_POSTER_PATH = "poster_path";
